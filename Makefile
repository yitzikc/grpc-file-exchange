...
all: system-check $(PROJECT_NAME)_client $(PROJECT_NAME)_server

$(PROJECT_NAME)_client: $(COMMON_OBJS) $(PROJECT_NAME)_client.o
	$(CXX) $^ $(LDFLAGS) -o $@

$(PROJECT_NAME)_server: $(COMMON_OBJS) $(PROJECT_NAME)_server.o
	$(CXX) $^ $(LDFLAGS) -o $@
